  ...
  */
  getTotalWidgets(productionData: ProductionData): number {
    ...
    if (productionData && productionData.widgets) {
      if (productionData.widgets.blue) {
        totalWidgets += productionData.widgets.blue;
      }
      if (productionData.widgets.red) {
        totalWidgets += productionData.widgets.red;
      }
      if (productionData.widgets.green) {
        totalWidgets += productionData.widgets.green;
      }
      if (productionData.widgets.yellow) {
        totalWidgets += productionData.widgets.yellow;
      }
    }
    return totalWidgets;
  }
